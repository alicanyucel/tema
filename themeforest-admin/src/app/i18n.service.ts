...
const TRANSLATIONS: Record<AppLanguage, TranslationMap> = {
  tr: {
    ...
    'erp.edit': 'Düzenle',
    'erp.delete': 'Sil',
    'erp.deleteConfirmTitle': 'Emin misiniz?',
    'erp.deleteConfirmText': 'Bu kaydı silmek üzeresiniz. Bu işlem geri alınamaz.',
    'erp.deleteConfirmButton': 'Evet, sil',
    'erp.empty': 'Kayıt bulunamadı.',
    'erp.close': 'Kapat',
    'erp.cancel': 'İptal',
    'erp.add': 'Ekle',
    'erp.save': 'Kaydet',
    'erp.updateConfirmTitle': 'Güncellemek istediğinize emin misiniz?',
    'erp.updateConfirmText': 'Bu kayıttaki değişiklikler kaydedilecektir.',
    'erp.updateConfirmButton': 'Evet, güncelle',
  ...
  en: {
    ...
    'erp.edit': 'Edit',
    'erp.delete': 'Delete',
    'erp.deleteConfirmTitle': 'Are you sure?',
    'erp.deleteConfirmText': 'You are about to delete this record. This action cannot be undone.',
    'erp.deleteConfirmButton': 'Yes, delete',
    'erp.empty': 'No records found.',
    'erp.close': 'Close',
    'erp.cancel': 'Cancel',
    'erp.add': 'Add',
    'erp.save': 'Save',
    'erp.updateConfirmTitle': 'Are you sure you want to update?',
    'erp.updateConfirmText': 'Your changes to this record will be saved.',
    'erp.updateConfirmButton': 'Yes, update',
  ...
  ar: {
    ...
    'erp.edit': 'تعديل',
    'erp.delete': 'حذف',
    'erp.deleteConfirmTitle': 'هل أنت متأكد؟',
    'erp.deleteConfirmText': 'أنت على وشك حذف هذا السجل. لا يمكن التراجع عن هذا الإجراء.',
    'erp.deleteConfirmButton': 'نعم، احذف',
    'erp.empty': 'لا توجد سجلات.',
    'erp.close': 'إغلاق',
    'erp.cancel': 'إلغاء',
    'erp.add': 'إضافة',
    'erp.save': 'حفظ',
    'erp.updateConfirmTitle': 'هل أنت متأكد من التحديث؟',
    'erp.updateConfirmText': 'سيتم حفظ التغييرات على هذا السجل.',
    'erp.updateConfirmButton': 'نعم، حدّث',
